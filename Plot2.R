...
# Then it plots using the basic plot() function in R to match the reference plot. Lastly it outputs
# the completed plot to the working directory with the filename "Plot2.png"
#
